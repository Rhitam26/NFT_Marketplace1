# Crypto Batai NFT Marketplace
<i>NFT marketplace DApp where users mint ERC721 implemented Crypto Bantai NFTs.</i>
#
<img align="right" width="350" src="./image.png"></img>
### Features
- Mint custom ERC721 implemented Crypto Batai Tokens.
- Sell Crypto Banatai tokens on the marketplace.
...
- Crypto Banati Marketplace DApp requires [Metamask](https://metamask.io/) browser wallet extension to interact with.
...
```
git clone https://github.com/Rhitam26/NFT_Marketplace1/edit/main/cryptobantai-nft-marketplace.git
```
